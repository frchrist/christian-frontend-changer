            ...
            <div className="relative pt-6 px-4 sm:px-6 lg:px-8">
              <nav className="relative flex items-center justify-between sm:h-10 lg:justify-start" aria-label="Global">
                ...
                <div className="hidden md:block md:ml-10 md:pr-4 md:space-x-8 ">
                  {navigation.map((item) => (
                    <Link key={item.name} to={item.href} className="font-medium text-sm text-gray-500 hover:text-gray-900">
                      {item.name}
                    </Link>
                  ))}
                  <Link  to="/auth" className="btn-blue font-medium text-teal-600 hover:text-teal-500">
                    Connexion
                  </Link>
                </div>
              </nav>
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline">Echanges rapides <br/>  </span>{' '}
                <span className="block text-teal-600 xl:inline">en ligne</span>
              </h1>
