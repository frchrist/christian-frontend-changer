...
import { register_request as __registration__ } from "../../helpers/requests";
...
export default function Register() {
	...
	const handleSubmit = (e) => {
		e.preventDefault();
		__registration__(e.target, register_action, message_action, history);
	};
							...
							<div className="px-10 pt-2 pb-8 bg-white rounded-tr-4xl">
								...
								<div className="divide-y">
									<form className="mt-10 space-y-6 " action="" method="POST" onSubmit={handleSubmit}>
										...
										<AuthButton loading={running}>{button}</AuthButton>
									</form>
									<div className="mt-3">
