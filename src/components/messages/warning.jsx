export default function Warning({tag,message}){
	return <div className="fixed z-99 top-all top-5 right-5 bg-red-100 border-t-4 border-red-500 rounded-b text-red-900 px-4 py-3 shadow-md" role="alert">
		  <div className="flex">
