export default function Info({tag,message}){
	return <div className="fixed top-all w-96 top-5 right-5 bg-sky-100 border-t-4 border-sky-500 rounded-b text-sky-900 px-4 py-3 shadow-md" role="alert">
		  <div className="flex">
