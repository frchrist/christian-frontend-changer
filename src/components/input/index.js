...
export const Inputgroup = ({type,name,id,label, cls})=>{
	return <>
			<input id={id} defaultValue={""} type={type} name={name} className={"peer h-10 w-full border-b-2 border-gray-300 text-gray-900 placeholder-transparent focus:outline-none "+cls } placeholder={label} />
